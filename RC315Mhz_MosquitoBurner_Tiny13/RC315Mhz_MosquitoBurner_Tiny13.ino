/**************************************************************
  ...
  Name    : RC315Mhz_MosquitoBurner_Tiny13.ino
  Author  : Insoo Kim (insoo@hotmail.com)
  Date    : April 02, 2015    
  Update  : Wed Aug 12, 2015
  Objective: Control the power cycling time of electric mosquito repelant mat burner
  Desc    : 
    1) When system is on, the default power cycle period to relayPin is 10 min,
       
    2) Set the off interval of relayPin  via RF remote control keys. 
       A button: 20 min
       B button: 30 min 
       The on interval will remain unchanged as 10 min.
