/**************************************************************
  ...
  Name    : RC315Mhz_Decode_Tiny13.ino
...
#define Rx_D2 3 // Pi 3
#define Rx_D3 4 // Pi 4  
// Pi 7, 6, 5 (residual pins of CD4021) is connected to GND (0)
     
byte dirty = 0;                          // interrupt has occurred flag
...
void loop()
{
  ...
  if(dirty)
  {
    ...
    switch (FourBits)
    {
      case 4: // Button A: 0 1 0 0
      {
        digitalWrite(LEDH, LOW);
        digitalWrite(LEDL, HIGH);
        break;
      }
      case 1: // Button B: 0 0 0 1
      {
        digitalWrite(LEDH, HIGH);
        digitalWrite(LEDL, LOW);
        break;
      }
      case 8: // Button C: 1 0 0 0 
      {
        digitalWrite(LEDH, HIGH);
        digitalWrite(LEDL, HIGH);
        break;
      }
      case 2: // Button D: 0 0 1 0
      {
        digitalWrite(LEDH, LOW);
        digitalWrite(LEDL, LOW);
        break;
