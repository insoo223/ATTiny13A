...
Used IDE: Arduino Sketch 1.0.6
Author: Insoo Kim ( insoo@hotmail.com )
Date Created: Sunday, July 02, 2017 
Last Updated:
...
Ref:
 ...
 output of 153600 hz = 9600 baud * 16
*/ 
...
The three Clock Select bits select the clock source to be used by the Timer/Counter.*/
  TCCR0B |= (1 << CS02); // Prescaler table 11.9 (p74)
  TCCR0B |= (1 << CS00); // Prescaler table 11.9 by prescale 1024
